...
# Fonts
FONT_SM = pygame.font.Font("assets/fonts/Decrypted.ttf", 48)
FONT_MD = pygame.font.Font("assets/fonts/Decrypted.ttf", 80)
FONT_LG = pygame.font.Font("assets/fonts/Decrypted.ttf", 100)
...
# Images
hero_idle = load_image("assets/character/анприм.png")
hero_images = {
               "idle": hero_idle}
...
cave_img = load_image("assets/items/cave.png")
...
enemy1_img = load_image("assets/enemies/enemy1.png")
bear_images = [enemy1_img]
